# Generated by Django 3.1.4 on 2020-12-28 09:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.DecimalField(decimal_places=0, max_digits=10, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '+999999999'. Up to 10 digits allowed.", regex='^(\\+\\d{1,3})?,?\\s?\\d{10}')])),
                ('whatsapp', models.DecimalField(blank=True, decimal_places=0, max_digits=10, null=True, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '+999999999'. Up to 10 digits allowed.", regex='^(\\+\\d{1,3})?,?\\s?\\d{10}')])),
                ...
                ('merit', models.PositiveIntegerField(blank=True, choices=[(1, 'Merit1'), (2, 'Merit2'), (3, 'Merit3')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='users.profile')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.clcyear')),
            ],
        ),
        migrations.AddConstraint(
            model_name='feemaster',
            constraint=models.UniqueConstraint(fields=('course', 'feehead', 'gender', 'board'), name='Fee Structure already exist'),
        ),
        migrations.AddConstraint(
            model_name='composition',
